//Program to c++ to use priority_queue with class
#include<iostream>
#include<queue>
using namespace std;
...
{
    //this will return true when second person has greater height
    //Suppose we have p1.height = 5 and p2.height then the object which
    //have max height will be at the top(or max priority)
    cout << " hello\n";
