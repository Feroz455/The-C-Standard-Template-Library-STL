...
Cpp_STL_Reference
program search
iterator search(iterator start1, iterator endl, iterator start2, iterator end2)
iterator search(iterator start1, iterator endl, iterator start2, iterator end2, BinPred p);
